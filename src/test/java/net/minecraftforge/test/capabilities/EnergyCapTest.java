...
public class EnergyCapTest
{
    ...
    public void basicEnergyAdd()
    {
        ...
        final int received = storage.receiveEnergy(100, CapabilityEnergy.NORMAL);
    ...
    @Test
    public void basicEnergyAddBlock()
    {
        final EnergyStorage storage = new EnergyStorage(1000, 0, 10, 0);
    ...
    @Test
    public void basicEnergyAddMax()
    {
        final EnergyStorage storage = new EnergyStorage(1000, 1000, 1000, 990);
    ...
    public void basicEnergyAddBeyondLimit()
    {
        ...
        //Test the limits are still enforced
        final int received = storage.receiveEnergy(5000, CapabilityEnergy.NORMAL);
    ...
    public void basicEnergyRemove()
    {
        ...
        //Test the limits are still enforced
        final int extract = storage.extractEnergy(100, CapabilityEnergy.NORMAL);
    ...
    @Test
    public void basicEnergyRemoveBlock()
    {
        final EnergyStorage storage = new EnergyStorage(1000, 10, 0, 1000);
    ...
    @Test
    public void basicEnergyRemoveMax()
    {
        final EnergyStorage storage = new EnergyStorage(1000, 1000, 1000, 10);
    ...
    public void basicEnergyRemoveBeyondLimit()
    {
        ...
        //Test the limits are still enforced
        final int extract = storage.extractEnergy(5000, CapabilityEnergy.NORMAL);
    ...
    public void basicEnergyAddSimulate()
    {
        ...
        //Test the limits are still enforced
        final int received = storage.receiveEnergy(100, CapabilityEnergy.SIMULATE);
    ...
    public void basicEnergyRemoveSimulate()
    {
        ...
        //Test the limits are still enforced
        final int extract = storage.extractEnergy(100, CapabilityEnergy.SIMULATE);
    ...
    public void energyAddBypass()
    {
        ...
        //Test the limits are still enforced
        final int received = storage.receiveEnergy(100, CapabilityEnergy.IGNORE_LIMITS);
    ...
    public void energyRemoveBypass()
    {
        ...
        //Test the limits are still enforced
        final int extract = storage.extractEnergy(100, CapabilityEnergy.IGNORE_LIMITS);
    ...
    public void energyAddTakeAll()
    {
        ...
        //Test the limits are still enforced
        final int received = storage.receiveEnergy(10, CapabilityEnergy.MATCH_EXACT);
    ...
    public void energyRemoveTakeAll()
    {
        ...
        //Test the limits are still enforced
        final int extract = storage.extractEnergy(10, CapabilityEnergy.MATCH_EXACT);
    ...
    public void energyAddTakeAllFailLimit()
    {
        ...
        //Test the limits are still enforced
        final int received = storage.receiveEnergy(100, CapabilityEnergy.MATCH_EXACT);
    ...
    public void energyRemoveTakeAllFailLimit()
    {
        ...
        //Test the limits are still enforced
        final int extract = storage.extractEnergy(100, CapabilityEnergy.MATCH_EXACT);
